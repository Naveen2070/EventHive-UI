import { DollarSign, Plus, Ticket, Trash2, Users } from 'lucide-react'
  ...
  return (
    <div className="space-y-4 pt-2">
      <div className="flex items-center justify-between">
        ...
        <Button
          type="button"
          onClick={() => append({ name: '', price: 0, totalAllocation: 100 })}
          variant="outline"
          size="sm"
      ...
      <div className="space-y-3">
        {fields.map((field, index) => (
          <Card
            key={field.id}
            className="bg-slate-900/50 border-slate-800 relative group transition-all hover:border-slate-700"
          >
